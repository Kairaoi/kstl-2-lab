{{-- resources/views/kstl/client/edit.blade.php --}}
<x-app-layout>
    <x-slot name="header">
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;">
                    <div style="display:flex;align-items:center;gap:20px;">
                        ...
                        <div>
                            ...
                            <h1 style="font-family:'Georgia',serif;font-size:22px;font-weight:700;color:#fff;margin:0 0 6px;line-height:1.2;">Edit Client</h1>
                            <p style="font-size:12px;color:#94a3b8;margin:0;">{{ $client->company_name }}</p>
                        </div>
                    </div>
                    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
                        <a href="{{ route('client.show', $client->id) }}" style="display:inline-flex;align-items:center;gap:8px;padding:8px 20px;background:#fff;color:#1a2f4e;font-size:12px;font-weight:700;letter-spacing:.06em;border:1px solid rgba(255,255,255,.5);border-radius:3px;text-decoration:none;">
                            &larr; Back to Client
                        </a>
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('client.update', $client->id) }}">
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                            ...
                            <div style="grid-column:1/-1;">
                                ...
                                <textarea name="address" rows="3" required
                                          style="width:100%;padding:8px 12px;border:1px solid #cbd5e1;border-radius:3px;font-size:13px;color:#1e293b;background:#fff;resize:vertical;box-sizing:border-box;">{{ old('address', $client->address) }}</textarea>
                            </div>
                            <div>
                                ...
                                <input type="text" name="company_phone" value="{{ old('company_phone', $client->company_phone) }}"
                                       style="width:100%;padding:8px 12px;border:1px solid #cbd5e1;border-radius:3px;font-size:13px;color:#1e293b;background:#fff;box-sizing:border-box;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="padding:20px 24px;">
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                            <div>
                                ...
                                <input type="text" name="responsible_officer_name" value="{{ old('responsible_officer_name', $client->responsible_officer_name) }}"
                                       style="width:100%;padding:8px 12px;border:1px solid #cbd5e1;border-radius:3px;font-size:13px;color:#1e293b;background:#fff;box-sizing:border-box;">
                            </div>
                            <div>
                                ...
                                <input type="email" name="responsible_officer_email" value="{{ old('responsible_officer_email', $client->responsible_officer_email) }}"
                                       style="width:100%;padding:8px 12px;border:1px solid #cbd5e1;border-radius:3px;font-size:13px;color:#1e293b;background:#fff;box-sizing:border-box;">
                            </div>
                            <div>
                                ...
                                <input type="text" name="responsible_officer_phone" value="{{ old('responsible_officer_phone', $client->responsible_officer_phone) }}"
                                       style="width:100%;padding:8px 12px;border:1px solid #cbd5e1;border-radius:3px;font-size:13px;color:#1e293b;background:#fff;box-sizing:border-box;">
                            </div>
                        </div>
                    </div>
                ...
                <div style="background:#fff;border:1px solid #e2e8f0;border-radius:4px;overflow:hidden;margin-bottom:24px;">
                    ...
                    <div style="padding:20px 24px;">
                        <textarea name="internal_notes" rows="3"
                                  ...
                                  style="width:100%;padding:8px 12px;border:1px solid #cbd5e1;border-radius:3px;font-size:13px;color:#1e293b;background:#fff;resize:vertical;box-sizing:border-box;">{{ old('internal_notes', $client->internal_notes) }}</textarea>
                    </div>
                </div>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
                    <div style="display:flex;gap:10px;">
                        <a href="{{ route('client.show', $client->id) }}" style="display:inline-flex;align-items:center;gap:8px;padding:8px 20px;background:#fff;color:#1a2f4e;font-size:12px;font-weight:700;letter-spacing:.06em;border:1px solid #1a2f4e;border-radius:3px;text-decoration:none;">
                            Cancel
                        </a>
                    </div>
