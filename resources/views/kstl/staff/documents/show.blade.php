<x-app-layout>
            ...
            <div style="max-width:80rem;margin:0 auto;padding:28px 2rem 32px;">
                <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;">
                    <div style="display:flex;align-items:center;gap:20px;">
                        ...
                        <div>
                            <p style="font-size:9px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:#b8922a;margin:0 0 4px;">Staff Portal · {{ $document->category_label }}</p>
    ...
    <div style="background:#f1f5f9;min-height:100vh;padding:52px 0 56px;" x-data="{ showUpload: false }">
