    ...
    public function submissionsStore(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'tests_requested.*'     => ['string', 'in:total_coliforms,e_coli,enterococci,faecal_coliforms,yeast_mold,apc,e_coli_coliform,staph_aureus,salmonella_spp,listeria_mono,listeria_spp,clostridium,e_coli_colilert,total_coliform_colilert,enterococci_enterolert,histamine,moisture,temperature,ph,conductivity,water_activity'],
                ...
                'sample_items.*.tests.*'             => ['string', 'in:total_coliforms,e_coli,enterococci,faecal_coliforms,yeast_mold,apc,e_coli_coliform,staph_aureus,salmonella_spp,listeria_mono,listeria_spp,clostridium,e_coli_colilert,total_coliform_colilert,enterococci_enterolert,histamine,moisture,temperature,ph,conductivity,water_activity'],
